...
class TestTriangles(unittest.TestCase):
    ...
    def testNotATriangle2(self):
        self.assertNotEqual(classifyTriangle(201, 201, 202),'Isoceles','201, 201, 202 is invalid input')

    def testNotATriangle3(self):
        self.assertNotEqual(classifyTriangle(-1, -2, -2),'Isoceles','-1, -2, -2 is invalid input')

    def testNotATriangle4(self):
        self.assertEqual(classifyTriangle(1,2,1),'NotATriangle','1,2,1 should not be a triangle')
